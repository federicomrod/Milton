...
export function PDFReportGenerator() {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      const { generateReportSlides } =
        await import("@/lib/pdf-generator-slides");
        ...
        <CardContent className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="flex items-center space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleConfigChange("includeOverview", checked)
                  }
                />
              ...
              <div className="flex items-center space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleConfigChange("includeFinancial", checked)
                  }
                />
                <div className="space-y-1">
                  <Label
              ...
              <div className="flex items-center space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleConfigChange("includeSales", checked)
                  }
                />
                <div className="space-y-1">
                  <Label
              ...
              <div className="flex items-center space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleConfigChange("includeCashFlow", checked)
                  }
                />
                <div className="space-y-1">
                  <Label
          ...
          {generationStatus === "generating" && (
            <Alert>
              ...
              <AlertDescription>
                Generating your PDF report with real data and professional
                layout...
              </AlertDescription>
            </Alert>
          )}
            ...
            {config.includeOverview && (
              <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg border-l-4 border-green-500">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    MRR, ARR, Cash Balance, Burn Rate, etc.
                  </p>
                </div>
            ...
            {config.includeFinancial && (
              <div className="flex items-center justify-between p-4 bg-purple-50 rounded-lg border-l-4 border-purple-500">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Revenue breakdown, expense analysis, variance vs budget
                  </p>
                </div>
            ...
            {config.includeSales && (
              <div className="flex items-center justify-between p-4 bg-orange-50 rounded-lg border-l-4 border-orange-500">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Pipeline by stage, conversion rates, deal analysis
                  </p>
                </div>
            ...
            {config.includeCashFlow && (
              <div className="flex items-center justify-between p-4 bg-cyan-50 rounded-lg border-l-4 border-cyan-500">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Monthly trends, runway analysis, category breakdown
                  </p>
                </div>
