    ...
    <main className="max-w-6xl mx-auto px-4 py-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Upload your files and refine the data model for your business. When
          you are happy with the tables and relationships, continue to choose
          your key KPIs.
        </p>
      </div>
      ...
      <div className="flex justify-between">
        ...
        <Button type="button" onClick={() => router.push("/onboarding/kpis")}>
          Next: Choose KPIs
        </Button>
      </div>
    </main>
