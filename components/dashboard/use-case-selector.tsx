    ...
    <div className="space-y-6">
      <Card className="border-2 border-dashed border-blue-300 bg-blue-50">
        <CardHeader>
          ...
          <CardDescription>
            Choose your business model to get the most relevant metrics and
            insights. This helps our AI better understand your data structure
            and calculate the right KPIs.
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div className="mt-6 p-4 bg-white rounded-lg border">
                ...
                <div className="mt-4 p-3 bg-blue-50 rounded border border-blue-200">
                  ...
                  <p className="text-sm text-blue-800">
                    Our AI will use this business context to better interpret
                    your data files, identify the correct fields for
                    calculations, and provide industry-specific insights.
                  </p>
                </div>
