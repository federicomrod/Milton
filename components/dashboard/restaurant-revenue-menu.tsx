...
interface RestaurantRevenueMenuProps {
...
export function RestaurantRevenueMenu({
  period,
  customDateRange,
  onPeriodChange,
  onCustomDateRangeChange,
}: RestaurantRevenueMenuProps) {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/analytics/restaurant/revenue-menu?from_date=${fromDateStr}&to_date=${toDateStr}&period=${period}`,
        { cache: "no-store", credentials: "include" }
      );
      if (!response.ok) {
        throw new Error("Failed to fetch revenue & menu data");
      }
      ...
      setBottomItems(data.bottomItems || []);
    } catch (err) {
      console.error("Error fetching revenue & menu data:", err);
      setError("Failed to load revenue & menu data");
    } finally {
      setLoading(false);
    }
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  {topItems.some((item) => item.margin !== null) && (
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>Qty</TableHead>
                  <TableHead>Share</TableHead>
                  {bottomItems.some((item) => item.margin !== null) && (
                    <TableHead>Margin</TableHead>
                  )}
                </TableRow>
              </TableHeader>
