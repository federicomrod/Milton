    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            File: <strong>{fileName}</strong> | Detected:{" "}
            {structure.language.toUpperCase()} language, {structure.type}{" "}
            structure
          </CardDescription>
        </CardHeader>
      </Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div>
              ...
              <Select
                value={structure.language}
                onValueChange={(value) => updateStructure("language", value)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) => updateStructure("type", value)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="single-category">
                    Single Category Column
                  </SelectItem>
                  <SelectItem value="multi-category">
            ...
            <div>
              ...
              <Select
                value={structure.dateFormat}
                onValueChange={(value) => updateStructure("dateFormat", value)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div>
              ...
              <Select
                value={structure.currencySymbol}
                onValueChange={(value) =>
                  updateStructure("currencySymbol", value)
                }
              >
                <SelectTrigger>
                  <SelectValue />
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <Select
                      ...
                      onValueChange={(value) =>
                        updateMapping(mapping.original, value)
                      }
                    >
      ...
      {!isValid() && (
        <Alert>
          ...
          <AlertDescription>
            Please map at least the <strong>Date</strong> and{" "}
            <strong>Amount</strong> fields to continue.
          </AlertDescription>
        </Alert>
      )}
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    {mappings
                      .filter((m) => m.standardField !== "ignore")
                      .map((mapping) => (
                        <th
