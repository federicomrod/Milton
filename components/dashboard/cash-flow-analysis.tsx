    ...
    <div className="space-y-6" data-chart="cash-flow">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div
              className={`text-2xl font-bold ${metrics.monthlyFlow.length > 0 && metrics.monthlyFlow[metrics.monthlyFlow.length - 1].netFlow >= 0 ? "text-green-600" : "text-red-600"}`}
            >
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <AreaChart data={metrics.monthlyFlow}>
              ...
              <Tooltip
                formatter={(value: any) =>
                  formatCurrency(value, prefs.currency)
                }
              />
              <Area
                type="monotone"
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <div className="flex space-x-4 text-xs text-gray-500">
                        <span>
                          In: {formatCurrency(cat.inflow, prefs.currency)}
                        </span>
                        <span>
                          Out: {formatCurrency(cat.outflow, prefs.currency)}
                        </span>
                      </div>
                    </div>
                    <div
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={metrics.monthlyFlow}>
              ...
              <Line
                ...
                dot={{ fill: "#6366f1" }}
              />
              <Line y={0} stroke="#000" strokeWidth={1} strokeDasharray="3 3" />
            </LineChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
